-- CreateEnum
CREATE TYPE "OfferedCourseClassScheduleDayOfWeek" AS ENUM ('SATURDAY', 'SUNDAY', 'MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY');
...
CREATE TABLE "offered_course_class_schedule" (
    ...
    "dayOfWeek" "OfferedCourseClassScheduleDayOfWeek" NOT NULL DEFAULT 'SATURDAY',
